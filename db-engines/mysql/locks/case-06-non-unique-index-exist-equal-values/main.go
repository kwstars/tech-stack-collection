...
func main() {
	...
	go func() {
		...
		execSQL(sessionA, "A", "DELETE FROM t WHERE c = 10;")
		t2 <- true
	...
	go func() {
		...
		execSQL(sessionB, "B", "INSERT INTO t VALUES(13, 50, 13);")
		execSQL(sessionB, "B blocked", "INSERT INTO t VALUES(12, 12, 12);")
	...
	go func() {
		...
		execSQL(sessionC, "C", "UPDATE t SET d = d + 1 WHERE c = 15;")
