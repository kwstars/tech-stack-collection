...
func main() {
	...
	go func() {
		...
		execSQL(sessionA, "A", "SELECT * FROM t WHERE id >= 10 AND id < 11 FOR UPDATE;")
		t2 <- true
	...
	go func() {
		...
		execSQL(sessionB, "B", "INSERT INTO t VALUES(8, 8, 8);")
		execSQL(sessionB, "B blocked", "INSERT INTO t VALUES(13, 13, 13);")
	...
	go func() {
		...
		execSQL(sessionC, "C", "UPDATE t SET d = d + 1 WHERE id = 15;")
