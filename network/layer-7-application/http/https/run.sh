...
# SSLKEYLOGFILE=/mnt/c/Users/Kira/sslkeylog/sslkeylog.log curl -vso /dev/null --capath ./ --cacert ca.crt --http1.1 --tlsv1.2 --tls-max 1.2 https://foo.bar.com
# SSLKEYLOGFILE=/mnt/c/Users/Kira/sslkeylog/sslkeylog.log curl -vso /dev/null --capath ./ --cacert ./ca.crt --http1.1 --tlsv1.3 https://foo.bar.com
# SSLKEYLOGFILE=/mnt/c/Users/Kira/sslkeylog/sslkeylog.log curl -vso /dev/null --capath ./ --cacert ./ca.crt --http2 --tlsv1.2 --tls-max 1.2 https://foo.bar.com
# SSLKEYLOGFILE=/mnt/c/Users/Kira/sslkeylog/sslkeylog.log curl -vso /dev/null --capath ./ --cacert ./ca.crt --http2 --tlsv1.3 https://foo.bar.com
