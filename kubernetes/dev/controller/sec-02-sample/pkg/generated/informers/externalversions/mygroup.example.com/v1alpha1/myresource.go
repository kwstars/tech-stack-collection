...
import (
	...
	mygroupexamplecomv1alpha1 "github.com/kwstars/controller-sample/pkg/apis/mygroup.example.com/v1alpha1"
	versioned "github.com/kwstars/controller-sample/pkg/generated/clientset/versioned"
	internalinterfaces "github.com/kwstars/controller-sample/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/kwstars/controller-sample/pkg/generated/listers/mygroup.example.com/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MygroupV1alpha1().MyResources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MygroupV1alpha1().MyResources(namespace).Watch(context.TODO(), options)
			},
		},
		&mygroupexamplecomv1alpha1.MyResource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *myResourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mygroupexamplecomv1alpha1.MyResource{}, f.defaultInformer)
}
