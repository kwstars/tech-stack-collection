...
function pull_and_load_images() {
  ...
  local IMAGES=(
    ...
    # cert-manager
    "quay.io/jetstack/cert-manager-cainjector:v1.12.10"
    "quay.io/jetstack/cert-manager-controller:v1.12.10"
    "quay.io/jetstack/cert-manager-ctl:v1.12.10"
    "quay.io/jetstack/cert-manager-webhook:v1.12.10"
