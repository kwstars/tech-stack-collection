...
# Prepare noCNI env
kind create cluster --name=calico-bgp-full-mesh --image=mykindest/node:v1.28.7 --config=./kind.yaml
...
# Captrue packets
docker exec -d calico-bgp-full-mesh-control-plane bash -c "tcpdump -pen -i eth0 -w /data/control-eth0.pcap"
